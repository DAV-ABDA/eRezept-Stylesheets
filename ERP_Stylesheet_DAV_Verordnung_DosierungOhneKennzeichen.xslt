            ...
            <head>
                ...
                <style>
                    <xsl:text disable-output-escaping='yes'>
                        ...
                        /* Minimales optimiertes Bootstrap Grid System v5.3.0 (https://getbootstrap.com/)
                ...
                <style>
                    ...
                    input[type="checkbox"]:checked {
                        background-color: var(--background-color-ges);
                        border-color: var(--text-color-ges);
                    }
                    ...
                    <xsl:when test="fhir:Bundle">
                        <xsl:choose>
                            ...
                            <xsl:otherwise>
                                <b>ERP Stylesheet Verordnung</b>
                                <br/>
                                <b>!!! Profile-Version stimmt nicht bzw. wird nicht unterstützt!!!</b>
                                <br/>
            ...
            <div class="row g-1 intern-container">
                <div class="col-md-6 border-1">
                        ...
                        <div class="col-3">
                            <div class="input-container"> <!-- Kostenträger -->
                                <xsl:choose>
                                    ...
                                    <xsl:otherwise> <!-- oder immer ausgeben? -->
                    ...
                    <div class="row g-1">
                        ...
                        <xsl:choose>
                            <xsl:when test="//fhir:entry/fhir:resource/fhir:MedicationRequest/fhir:basedOn/fhir:identifier[fhir:system/@value='https://gematik.de/fhir/sid/emp-identifier']">
                                <!-- Ausgabe der Referenz? xsl:value-of select="//fhir:entry/fhir:resource/fhir:MedicationRequest/fhir:basedOn/fhir:identifier[fhir:system/@value='https://gematik.de/fhir/sid/emp-identifier']/fhir:value/@value"/-->
                                <div class="col-6">
                                    <div class="input-container">
                                ...
                                <div class="row g-1">
                                    ...
                                    <div class="col-10">
                                        <div class="input-container">
                                            ...
                                            <textarea class="text-input" style="font-weight: bold;" readonly="readonly">
                                ...
                                <div class="row g-1">
                                    <div class="col-4"> <!-- Darreichungsform Text (ID 103)-->
                                        <div class="input-container">
                                            ...
                                            <!-- Anzeige Display-Value? form.coding:kbvDarreichungsform.display -->
                                ...
                                <xsl:for-each select="fhir:entry/fhir:resource/fhir:Medication/fhir:ingredient"> <!-- ab Version 1.3 Angabe des Wirkstoffs -->
                                    <xsl:if test="not(fhir:itemCodeableConcept/fhir:extension[@url='http://hl7.org/fhir/StructureDefinition/data-absent-reason'])">
                                        <div class="row g-1">
                                            ...
                                            <div class="col-6">
                                                <div class="input-container">
                                                    <label>Wirkstoffname</label> <!-- 80 Zeichen -->
                                                    <textarea class="text-input" style="font-weight: bold;" readonly="readonly">
                                ...
                                <div class="row g-1">
                                    <div class="col-12">
                                        <div class="input-container">
                                            ...
                                            <textarea class="text-input height-20mm" readonly="">
                                                <xsl:value-of select="fhir:entry/fhir:resource/fhir:Medication/fhir:code/fhir:text/@value"/>
                                            </textarea>
                                        </div>
                                    </div>
                                ...
                                <div class="input-container">
                                    <xsl:choose>
                                        ...
                                        <!--xsl:when test="//fhir:entry/fhir:resource/fhir:MedicationRequest/fhir:extension[@url='https://fhir.kbv.de/StructureDefinition/KBV_EX_ERP_DosageFlag']">
                                            <xsl:choose-->
                                                <xsl:when test="(//fhir:entry/fhir:resource/fhir:MedicationRequest/fhir:extension[@url='https://fhir.kbv.de/StructureDefinition/KBV_EX_ERP_DosageFlag']/fhir:valueBoolean[@value='true']) or (//fhir:entry/fhir:resource/fhir:MedicationRequest/fhir:extension[@url='http://hl7.org/fhir/5.0/StructureDefinition/extension-MedicationRequest.renderedDosageInstruction'])">
        ...
        <script>
            <xsl:text disable-output-escaping='yes'>
                <![CDATA[
                    ...
                    // Auch bei Seitenladefertigstellung neu anpassen
					window.addEventListener('load', () => {
                        document.querySelectorAll('textarea.text-input').forEach(ta => {
